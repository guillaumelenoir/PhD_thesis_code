...
def dt_av(t,D,mywindow):
	
	""" dt_av returns the average weighted time step on a given WOSA segment. The weight is the taper window and is computed at mid-times:
